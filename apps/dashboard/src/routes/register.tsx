      ...
      <div className="w-full max-w-[400px] space-y-10">
        ...
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-400 text-base">Join SnapForge to start automating screenshots</p>
          </div>
        </div>
        ...
        <div className="text-center pt-4">
          <p className="text-gray-500 text-sm">
            ...
            <Link to="/login" className="font-bold text-white hover:underline underline-offset-4 ml-1">Log in</Link>
          </p>
        </div>
      </div>
    </div>
